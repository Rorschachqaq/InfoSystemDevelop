...
namespace Hotel
{
    public partial class PayDeposit : Form
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            ds =DBConnect.ExecuteQuery("select * from CustomerInfo where RoomNumber='" + roomNumber + "'");
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            deposit += newMoney;
            if (DBConnect.Execute("update CustomerInfo set Deposit='" + deposit + "' where ID='" + id + "'") > 0)
            {
        ...
        private void PayDeposit_Load(object sender, EventArgs e)
        {
