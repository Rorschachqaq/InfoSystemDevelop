...
namespace Hotel
{
    public partial class RoomManage : Form
    {
        ...
        {
            ds =DBConnect.ExecuteQuery("select RoomNumber as '房间号',RoomType as '房间类型',RoomPrice as '房间价格',RoomStatus as '房间状态',Remarks as '房间说明' from RoomInfo");
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            if (DBConnect.Execute("update RoomInfo set RoomType='" + roomType + "',RoomPrice='"
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            ...
            if (DBConnect.Execute("delete RoomInfo where RoomNumber='" + roomNumber + "'") > 0)
            {
