...
namespace Hotel
{
    public partial class RoomShow : Form
    {
        ...
        public RoomShow(string btnTag)
        {
            ...
            ds = DBConnect.ExecuteQuery("select RoomNumber as '房间号',RoomType as '房间类型',RoomPrice as '房间价格',RoomStatus as '房间状态',Remarks as '房间说明' from RoomInfo where RoomNumber='"+RoomNumber+"'");
            ...
            ds2 = DBConnect.ExecuteQuery(sql);
