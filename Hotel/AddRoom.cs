...
namespace Hotel
{
    public partial class AddRoom : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            //判断是否已经有了此房间
            DataSet ds = DBConnect.ExecuteQuery("select RoomNumber from RoomInfo where RoomNumber='" + roomNumber + "'");
...
;
            ...
            if (DBConnect.Execute("insert into RoomInfo(RoomNumber,RoomType,RoomPrice,Remarks) values('" + roomNumber + "','"
